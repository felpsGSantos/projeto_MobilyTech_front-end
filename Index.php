...
/* Fim roda pé */
    ...
    <nav class="menu-lateral"> <!-- Inicio Menu Lateral -->
        ...
        <aside class="h2pedidos"> <!-- Inicio Pedidos -->
            <span class="pedidos">Pedidos Frequentes</span></h2>
        </aside>
        ...
        <div class="container"> <!-- Inicio Comentarios -->
        <div class="images">
            <figure >
            <img src="assets/images/Inicial/homem-negro.jpg" alt="homem-negro">
            </figure>
        </div>
        ...
        <div class="btn">
            <p> Excelentes profissionais, pontual e acima de tudo confiável. Foi bastante educada e atenciosa com o trabalho, recomendo.</p>
    ...
    <div class="container">
        <div class="images">
            <img src="assets/images/Inicial/mulher.png" alt="mulher">
        </div>

        <div class="txt">
           <h1>Redes</h1>
           <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore aperiam illum earum sit necessitatibus perferendis exercitationem quis quasi, nulla temporibus quisquam, odit ducimus corrupti amet deleniti consequatur! Necessitatibus, possimus similique?</p>
        </div>
    ...
    <div class="container">
        <div class="images">
            <img src="assets/images/Inicial/homem.png" alt="homem">
        </div>
        ...
        <main> <!-- Title Contato -->
            <aside class="contat">
                <h2><span class="contato">Contatos</span></h2>
            </aside>
        </main> <!-- Fim Title Contato -->
